...
public class WindowView extends FrameLayout implements ViewTreeObserver.OnPreDrawListener {
     ...
     * @param y       悬浮窗在屏幕上的y坐标
     */
    public WindowView(Context context, int x, int y) {
        super(context);
        ...
        this.mMoveDirection = WindowView.MOVE_DIRECTION_DEFAULT;
    ...
    public boolean onPreDraw() {
        ...
        if (this.mMoveDirection == WindowView.MOVE_DIRECTION_NONE) {
    ...
    private void updateViewLayout(boolean isSizeChanged) {
        ...
        // WindowView size changed or device rotating
        if (isSizeChanged || oldScreenWidth != newScreenWidth || oldScreenHeight != newScreenHeight) {
            if (this.mMoveDirection == WindowView.MOVE_DIRECTION_DEFAULT) {
            ...
            } else if (this.mMoveDirection == WindowView.MOVE_DIRECTION_LEFT) {
                this.mParams.x = this.mPositionLimitRect.left;
            } else if (this.mMoveDirection == WindowView.MOVE_DIRECTION_RIGHT) {
        ...
        if (withAnimation) {
            ...
            this.mMoveEdgeAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    mWindowManager.updateViewLayout(WindowView.this, mParams);
                }
            });
            ...
            if (this.mParams.x != goalPositionX || this.mParams.y != goalPositionY) {
                ...
                this.mParams.y = goalPositionY;
                this.mWindowManager.updateViewLayout(WindowView.this, this.mParams);
            }
        }
        this.mViewTouchX = 0;
        this.mViewTouchY = 0;
